...
const SignUp = () => {
    ...
    const registerUser = async (values: z.infer<typeof registerSchema>) => {
        ...
        try {
            ...
            console.log(err)
            registerFailed("Failed to register admin")
            toast({
                variant: "destructive",
                title: "error",
                    ...
                    <div className="w-full bg-white shadow-md rounded-xl p-5">
                        ...
                        <div className='flex items-center gap-5'>
                            ...
                            <div>
                                ...
                                <p className='text-xs text-dark_green-600'>Please provide your details to sign up as admin</p>
                            </div>
                        </div>
                        ...
                        <div className='px-3'>
                            ...
                            <div className='w-full flex justify-center text-sm text-dark_green-300 my-3'>
                                <p>Already have an account? <Link href='/admin/auth/login' className='underline font-semibold'>Sign in</Link></p>
                            </div>
                        </div>
                    </div>
                </div>
