...
const BookAppointment = () => {
  return (
    <div className='grid grid-cols-2 gap-4'>
      <div className='border-r border-r-slate-400 h-full p-5'>
      ...
      <div className='p-5'>
        <div className='grid grid-cols-2 gap-5 mt-5'>
          ...
          <div className="mb-3">
            ...
            <div className="mt-5">
              <button type='submit' className='w-full px-10 py-2 text-sm bg-tea_green-100 text-white rounded-md'>Book</button>
