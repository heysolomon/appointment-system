...
const SignUp = () => {
    ...
    const registerSchema: Schema = z.object({
        ...
        One Number and one special case Character`).min(8, 'password must be atleast 8 characters long'),
        confirmPassword: z.string().refine(data => data === registerSchema.password, {
        ...
        <div className='bg-dark_green-900'>
            <div className='max-w-[1378px] mx-auto h-screen overflow-hidden grid grid-cols-1 md:grid-cols-2 bg-dark_green-900 px-5 md:px-0'>
                ...
                <div className='w-full h-full flex items-center justify-center md:pr-5'>
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="w-full bg-white shadow-md rounded-xl p-5">
                            {/* title */}
                            ...
                            <div className='px-3'>
                                ...
                                <div className='grid grid-cols-1 md:grid-cols-2 gap-3 mb-3'>
                                    <FormField control={form.control} name="email" render={({ field }) => (
                                        <FormItem className="mt-3">
                                            ...
                                            <FormControl>
                                                <Input type="email" id='email' name="email" className="w-full h-[35px] pl-1 text-sm rounded-md" />
                                            </FormControl>
                                    ...
                                    <FormField control={form.control} name="name" render={({ field }) => (
                                        <FormItem className="mt-3">
                                            ...
                                            <FormControl>
                                                <Input type="text" id='name' name="name" className="w-full h-[35px] pl-1 text-sm rounded-md" />
                                            </FormControl>
                                            <FormMessage className="text-red-500 text-xs" />
                                        </FormItem>
                                    )} />
                                ...
                                <FormField control={form.control} name="password" render={({ field }) => (
                                    <FormItem className="mb-3">
                                        ...
                                        <FormControl>
                                            <Input type="password" id='password' name="password" className="w-full h-[35px] pl-1 text-sm rounded-md" />
                                        </FormControl>
                                        <FormMessage className="text-red-500 text-xs" />
                                    </FormItem>
                                )} />
                                ...
                                <FormField control={form.control} name="confirmPassword" render={({ field }) => (
                                    <FormItem className="mb-3">
                                        ...
                                        <FormControl>
                                            <Input type="password" id='confirmPassword' name="confirmPassword" className="w-full h-[35px] pl-1 text-sm rounded-md" />
                                        </FormControl>
                                        <FormMessage className="text-red-500 text-xs" />
                                    </FormItem>
                                )} />
